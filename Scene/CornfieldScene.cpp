...
void CornfieldScene::update() {
    ...
    if (this->frameCount == 1) {
        ...
        Core::WeakPointer<Core::CubeTexture> irradianceMap = Core::WeakPointer<Core::Texture>::dynamicPointerCast<Core::CubeTexture>(this->centerProbe->getSpecularIBLPreFilteredMapRenderTarget()->getColorTexture());
...
void CornfieldScene::setupDefaultObjects() {
    ...
    this->modelerApp.loadModel("assets/models/metal_tank/Water_Tank_fbx.fbx", 3.0f, 80, false, true, true, [this](Core::WeakPointer<Core::Object3D> rootObject){
